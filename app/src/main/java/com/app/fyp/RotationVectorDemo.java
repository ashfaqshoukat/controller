...
public class RotationVectorDemo extends AppCompatActivity     implements SensorEventListener {
...
//                Log.i("rotation","180 rotation");
                Toast.makeText(RotationVectorDemo.this,"180",Toast.LENGTH_SHORT).show();
                SensorManager.remapCoordinateSystem(rotationMatrix,
...
//                Log.i("rotation","270 rotation");
                Toast.makeText(RotationVectorDemo.this,"270",Toast.LENGTH_SHORT).show();
                SensorManager.remapCoordinateSystem(rotationMatrix,
        ...
        if (roll > 0) {
            ...
            Toast.makeText(RotationVectorDemo.this,"Right",Toast.LENGTH_SHORT).show();
        } else {
            mSpotRight.setAlpha(Math.abs(roll));
            Toast.makeText(RotationVectorDemo.this,"Left",Toast.LENGTH_SHORT).show();
        }
    }
